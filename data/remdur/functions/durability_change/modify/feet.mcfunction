...
data modify storage remdur:item_dura item.Damage[0] set from entity @s[type=player] Inventory[{Slot:100b}].tag.Damage
data modify storage remdur:item_dura item.Damage[0] set from entity @s[type=!player] ArmorItems[0].tag.Damage
#Damage the item completely and get it's max value in the right
item modify entity @s armor.feet remdur:get_max
data modify storage remdur:item_dura item.Damage[1] set from entity @s[type=player] Inventory[{Slot:100b}].tag.Damage
data modify storage remdur:item_dura item.Damage[1] set from entity @s[type=!player] ArmorItems[0].tag.Damage
...
execute if score $maxdmg remdur.data matches 1.. if score $tempdmg remdur.data < $maxdmg remdur.data run item modify entity @s armor.feet remdur:copy_damage

#If the Damage score exceeds the max score, clear the item
execute if score $maxdmg remdur.data matches 1.. if score $tempdmg remdur.data >= $maxdmg remdur.data run item replace entity @s armor.feet with air
