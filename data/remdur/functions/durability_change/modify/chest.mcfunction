...
data modify storage remdur:item_dura item.Damage[0] set from entity @s[type=player] Inventory[{Slot:102b}].tag.Damage
data modify storage remdur:item_dura item.Damage[0] set from entity @s[type=!player] ArmorItems[2].tag.Damage
#Damage the item completely and get it's max value in the right
item modify entity @s armor.chest remdur:get_max
data modify storage remdur:item_dura item.Damage[1] set from entity @s[type=player] Inventory[{Slot:102b}].tag.Damage
data modify storage remdur:item_dura item.Damage[1] set from entity @s[type=!player] ArmorItems[2].tag.Damage
...
execute if score $maxdmg remdur.data matches 1.. if score $tempdmg remdur.data < $maxdmg remdur.data run item modify entity @s armor.chest remdur:copy_damage

#If the Damage score exceeds the max score, clear the item
execute if score $maxdmg remdur.data matches 1.. if score $tempdmg remdur.data >= $maxdmg remdur.data run item replace entity @s armor.chest with air
